            ...
            <table class="table table-hover mb-0 text-center seguimiento-resumen">
                ...
                @forelse($pedidos as $pedido)
                    ...
                    <tr>
                        ...
                        <td class="align-middle"><small>{{ optional($pedido->created_at)->format('d/m/Y') }}</small></td>
                ...
                @empty
                    <tr><td colspan="9" class="text-center text-muted py-4">Todavía no hay pedidos importados.</td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
